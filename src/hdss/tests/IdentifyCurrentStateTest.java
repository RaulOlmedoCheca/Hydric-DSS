...
public class IdentifyCurrentStateTest {
	 ...
	 */
 	...
 	public void emptyFileTest() {
 		try {
 			manager.RegisterHydricResources("data/RF02/hdss-rf02-empty.json");
 	...
 	public void existingIrrigationBasinTest() {
 		try {
 			manager.RegisterHydricResources("data/RF02/hdss-rf02-existingIrrigationBasinName.json");
 	...
 	public void existingResourceNameTest() {
 		manager.RegisterHydricResources("data/RF02/hdss-rf02-validRegisterHydricResourcesCase.json");
 		try {
 			manager.RegisterHydricResources("data/RF02/hdss-rf02-validRegisterHydricResourcesCase.json");
