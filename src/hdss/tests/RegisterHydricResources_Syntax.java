...
public class RegisterHydricResources_Syntax {
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {
			...
			{"data/RF01_syntax/hdss-rf01-syntaxError38.json", "Modification of {", "HDSS-RF-01 Syntax Error: Modification of nodes"},
			{"data/RF01_syntax/hdss-rf01-syntaxError39.json", "Modification of }", "HDSS-RF-01 Syntax Error: Modification of nodes"},
			{"data/RF01_syntax/hdss-rf01-syntaxError40.json", "Modification of body", "HDSS-RF-01 Syntax Error: Modification of nodes"},
			{"data/RF01_syntax/hdss-rf01-syntaxError41.json", "Modification of :", "HDSS-RF-01 Syntax Error: Modification of nodes"},
			{"data/RF01_syntax/hdss-rf01-syntaxError42.json", "Modification of [", "HDSS-RF-01 Syntax Error: Modification of nodes"},
			{"data/RF01_syntax/hdss-rf01-syntaxError43.json", "Modification of ]", "HDSS-RF-01 Syntax Error: Modification of nodes"},
			{"data/RF01_syntax/hdss-rf01-syntaxError44.json", "Modification of left quotes", "HDSS-RF-01 Syntax Error: Modification of nodes"},
			{"data/RF01_syntax/hdss-rf01-syntaxError45.json", "Modification of right quotes", "HDSS-RF-01 Syntax Error: Modification of nodes"},
			{"data/RF01_syntax/hdss-rf01-syntaxError46.json", "Modification of name resource label", "HDSS-RF-01 Syntax Error: Modification of nodes"},
			{"data/RF01_syntax/hdss-rf01-syntaxError47.json", "Modification of type resource label", "HDSS-RF-01 Syntax Error: Modification of nodes"},
			{"data/RF01_syntax/hdss-rf01-syntaxError48.json", "Modification of type resource value", "HDSS-RF-01 Syntax Error: Modification of nodes"},
			{"data/RF01_syntax/hdss-rf01-syntaxError49.json", "Modification of capacity resource label", "HDSS-RF-01 Syntax Error: Modification of nodes"},
			{"data/RF01_syntax/hdss-rf01-syntaxError50.json", "Modification of .", "HDSS-RF-01 Syntax Error: Modification of nodes"},
			{"data/RF01_syntax/hdss-rf01-syntaxError51.json", "Modification of ,", "HDSS-RF-01 Syntax Error: Modification of nodes"}
		});
	}
